/**
 * LUT library — 30 cinematic looks authored as parameter recipes.
 *
 * Each look targets a recognizable cinematic feel: a film stock
 * (Kodak 2383, Fuji Eterna), an era (60s, 80s, Y2K), a mood (noir,
 * dreamy, neon), or a director's signature palette (Roma, Wong Kar-wai,
 * Bladerunner).
 *
 * The parameters were tuned by ear and reference — these aren't sampled
 * from real .cube files, they're synthesized to evoke the same feel
 * while staying tiny and tweakable.
 */
import type { LutLook } from "./color-grade";
