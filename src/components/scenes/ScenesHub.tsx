...
const glassHover = 'hover:bg-glass-active hover:border-white/[0.12]';
...
export function ScenesHub() {
  ...
  const statusBadge = (status: string) => {
    const map: Record<string, string> = {
      ...
      draft: 'bg-glass-active text-white/40 border-white/[0.1]',
    };
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm ${textSecondary} hover:text-white/80 hover:bg-glass-active transition-all`}
            >
          ...
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'builder' | 'analytics')}>
            <TabsList className="bg-glass-hover border border-white/[0.08] p-1 rounded-xl">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
              ...
              <DialogContent className="bg-surface-1 border-white/[0.1]">
                <DialogHeader>
                ...
                <div className="space-y-4 pt-4">
                  <Input
                    ...
                    className="bg-glass-active border-white/[0.1] text-white placeholder:text-white/30"
                  />
          ...
          {isLoading ? (
            ...
            <div className={`text-center py-24 rounded-2xl border border-dashed border-white/[0.1] bg-glass`}>
              <div className="w-16 h-16 mx-auto rounded-2xl bg-glass-hover border border-white/[0.08] flex items-center justify-center mb-6">
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        ...
                        <div key={label} className="text-center py-2.5 rounded-xl bg-glass-hover border border-white/[0.06]">
                    ...
                    {/* Divider */}
                    <div className="h-px bg-glass-active" />
