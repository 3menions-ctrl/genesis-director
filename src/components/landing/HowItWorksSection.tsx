...
const LAYERS = [
  ...
  { icon: Zap, title: 'Seedance 2.0 Engine', desc: 'Lens-aware cinema engine — physics-grade motion, native audio, end-frame chaining', color: '#0A84FF', stat: '1080p', statLabel: '24fps cinema' },
] as const;
