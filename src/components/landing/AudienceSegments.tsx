...
const SEGMENTS = [
  {
    ...
    points: [
      ...
      'AI scriptwriter turns ideas into shot-ready screenplays',
      'Frame-chained continuity keeps characters consistent across clips',
    ],
  ...
  },
  {
    ...
    points: [
      'Long-form video stitching — chain clips into 30s, 60s, multi-minute cuts',
      'Multi-character dialogue with synced lip-sync and cinematic camera moves',
      'Native scoring + dialogue ducking baked into every export',
    ],
  ...
  },
  {
    ...
    points: [
      'Face-Lock identity engine prevents character drift across every shot',
      'Image-to-video scene DNA — extend any still into a directed sequence',
      'Resilient pipeline with watchdog recovery for unattended bulk renders',
    ],
