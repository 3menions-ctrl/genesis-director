...
export default function Press() {
  usePageMeta({ title: 'Press — Small Bridges', description: 'Press kit, media resources, and the latest news about Small Bridges AI video platform.' });
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      {/* Animated Background */}
      <div className="fixed inset-0 pointer-events-none">
        {/* GPU-optimized: Removed animate-pulse and reduced blur for heavy backgrounds */}
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[80px] opacity-60" style={{ willChange: 'opacity' }} />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-violet-500/5 rounded-full blur-[60px] opacity-50" style={{ willChange: 'opacity' }} />
      ...
      <header className="border-b border-border/40 backdrop-blur-xl bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <span className="font-bold text-xl">Small Bridges</span>
          </Link>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
              Small Bridges is a video creation platform that uses AI to help transform 
            ...
            <div className="relative p-10 md:p-16 rounded-3xl bg-gradient-to-br from-primary/10 via-violet-500/5 to-pink-500/10 border border-primary/20">
              ...
              <div className="relative">
                <h2 className="text-2xl md:text-3xl font-medium leading-relaxed mb-8 text-center">
                  ...
                  Small Bridges combines multiple AI technologies into a single platform 
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Key features of the Small Bridges video creation platform
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Small Bridges is designed for a variety of video creation needs
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">© 2026 Small Bridges. All rights reserved.</span>
            </div>
