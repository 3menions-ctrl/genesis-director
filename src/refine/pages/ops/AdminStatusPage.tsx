  ...
  return (
    ...
    >
      <div className="space-y-3">
        {loading && <AdminSurface><div className="text-[#9aa4b8] text-sm">Probing components…</div></AdminSurface>}
        {components.map(c => (
          <AdminSurface key={c.name} className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-[#0c1426] text-[14px] font-medium">{c.name}</div>
                <div className="text-[#9aa4b8] font-mono text-[11px] uppercase tracking-[0.18em] mt-0.5">{c.detail}</div>
              </div>
            </div>
