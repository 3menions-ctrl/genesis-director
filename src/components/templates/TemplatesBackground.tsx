...
export default function TemplatesBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Animated flowing circles - stunning violet/purple palette */}
      <svg 
      ...
      >
        <defs>
          {/* Premium purple/violet gradients */}
          <linearGradient id="violetGlow1" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <linearGradient id="violetGlow2" x1="100%" y1="0%" x2="0%" y2="100%">
          ...
          <linearGradient id="violetGlow3" x1="50%" y1="0%" x2="50%" y2="100%">
          ...
          <radialGradient id="circleGlowViolet1" cx="50%" cy="50%" r="50%">
          ...
          <radialGradient id="circleGlowViolet2" cx="50%" cy="50%" r="50%">
          ...
          <filter id="heavyGlowViolet" x="-100%" y="-100%" width="300%" height="300%">
        ...
        <motion.circle
          ...
          cy="20%"
          r="250"
          fill="url(#circleGlowViolet1)"
          filter="url(#heavyGlowViolet)"
