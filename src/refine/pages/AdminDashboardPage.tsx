...
export default function AdminDashboardPage() {
  ...
  const cards = useMemo<ActionCard[]>(() => {
    ...
    if (Math.abs(pulse.credits.spend_24h_signed) > 0) { const spend = Math.abs(pulse.credits.spend_24h_signed); items.push({ priority: "low", icon: Coins, title: `${spend.toLocaleString()} credits burned in the last 24h`, body: "Track engine spend — if this rises sharply, investigate for abuse.", ctaLabel: "Open ledger", ctaTo: "/admin/credits" }); }
