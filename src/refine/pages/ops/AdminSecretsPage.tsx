...
const SPEC: SecretSpec[] = [
  ...
  { key: "RESEND_API_KEY", description: "Resend API key — sends all auth & transactional email", category: "email" },
  { key: "SEND_EMAIL_HOOK_SECRET", description: "Supabase Auth Send Email Hook signing secret (v1,whsec_…)", category: "email" },
