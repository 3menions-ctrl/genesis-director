...
const BUILT_IN_TEMPLATES: BuiltInTemplate[] = [
  ...
  // NOTE: conceptPrompt is intentionally EMPTY for breakout templates.
  // Users provide DIALOGUE (what avatar says), not scene descriptions.
  // The 3-clip scene structure is auto-generated by the hollywood-pipeline.
  {
    ...
    conceptPrompt: '', // User provides dialogue only - scene structure is auto-generated
  },
  {
    id: 'breakout-youtube',
