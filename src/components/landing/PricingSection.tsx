...
const ImmersiveVideoBackground = memo(function ImmersiveVideoBackground({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[2] pointer-events-none animate-fade-in" style={{ animationDuration: '1.2s' }}>
      ...
      {/* Floating controls - top right, must be interactive */}
      <div className="fixed top-20 right-6 z-[60] flex items-center gap-3 pointer-events-auto animate-fade-in" style={{ animationDelay: '0.6s' }}>
        ...
        <button
          onClick={onClose}
          className="group flex items-center justify-center w-10 h-10 rounded-full bg-black/50 backdrop-blur-xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 pointer-events-auto"
