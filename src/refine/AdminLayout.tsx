/**
 * Refine Admin Layout — Apple-esque dark admin shell with full nav.
 * 
 * Wraps all /admin/* routes with sidebar + header + admin gate.
 * Integrates Refine for data provider hooks in child pages.
 */
...
import { refineAuthProvider } from "./authProvider";
import { refineDataProvider } from "./dataProvider";
...
const REFINE_RESOURCES = [
  { name: "admin_users", list: "/admin/users", show: "/admin/users/:id" },
  { name: "admin_projects", list: "/admin/projects" },
  { name: "credit_transactions", list: "/admin/credits" },
  { name: "support_messages", list: "/admin/messages" },
  { name: "admin_audit_log", list: "/admin/audit" },
];
