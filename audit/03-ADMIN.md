# 03 — Admin App: Deep Feature Trace

> Surface: standalone admin build (`admin.html` → `src/admin/main-admin.tsx` → `src/refine/*`), shipped as a noindex Vercel subdomain and an Electron desktop app ("Small Bridges Admin.app"). Branch: `full-audit`.
