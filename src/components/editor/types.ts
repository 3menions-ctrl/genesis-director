...
export const EFFECT_PRESETS = [
  ...
  { id: "vhs", name: "VHS", category: "trending", description: "Retro tape look", css: "contrast(120%) saturate(80%) brightness(110%) sepia(15%)" },
  { id: "zoom-pulse", name: "Zoom Pulse", category: "trending", description: "Rhythmic zoom beats", css: "contrast(110%) brightness(105%)", transform: "scale(1.05)" },
  { id: "shake", name: "Shake", category: "trending", description: "Camera shake effect", css: "contrast(115%) brightness(102%)", transform: "translate(2px, -1px)" },
  { id: "blur-reveal", name: "Blur Reveal", category: "trending", description: "Focus pull transition", css: "blur(0.5px) brightness(105%)" },
  { id: "rgb-split", name: "RGB Split", category: "trending", description: "Chromatic aberration", css: "contrast(110%) saturate(150%) brightness(105%)" },
  { id: "film-grain", name: "Film Grain", category: "cinematic", description: "Analog film texture", css: "contrast(105%) brightness(98%) saturate(90%) sepia(10%)" },
  { id: "flash", name: "Flash", category: "trending", description: "White flash beat sync", css: "brightness(160%) contrast(120%)" },
  { id: "mirror", name: "Mirror", category: "creative", description: "Mirror reflection", css: "none", transform: "scaleX(-1)" },
  { id: "slow-zoom", name: "Ken Burns", category: "cinematic", description: "Slow cinematic zoom", css: "brightness(102%) contrast(105%)", transform: "scale(1.03)" },
