# 01 — iOS Native App: Deep Feature Trace

> Surface: `ios-app` branch (Capacitor 8 / SPM shell, product brand "Small Bridges", `co.smallbridges.app`). Worktree: /Users/briancole/Developer/genesis-director-ios
> **STATIC AUDIT ONLY** — no Xcode toolchain on this host, nothing built or run. Every DONE below is code-path verified, not runtime-verified.
