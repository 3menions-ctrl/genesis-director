...
export const AccountSettings = memo(forwardRef<HTMLDivElement, Record<string, never>>(function AccountSettings(_, ref) {
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      surfaceError(error, "Avatar upload failed — try a smaller image or different format.", {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      surfaceError(error, "Couldn't save your profile — your changes weren't applied.", {
        surface: 'settings.account',
  ...
  const handleEmailChange = async () => {
    ...
    try {
      ...
      surfaceError(error, "Couldn't change your email — the request didn't go through.", {
        surface: 'settings.account',
        action: 'change-email',
      });
    } finally {
