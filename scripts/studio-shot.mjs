...
const ID="bb77364d-047b-4abb-a726-eca49d33e40d",EM="demo-mira@smallbridges.test",P=`St!${Date.now()}x`;
...
await pg.goto("http://localhost:7788/studio",{waitUntil:"networkidle",timeout:60000});
await pg.waitForTimeout(3500);
await pg.screenshot({path:"/tmp/fresh-studio.png",fullPage:true});
console.log("studio",pg.url());
await b.close();
