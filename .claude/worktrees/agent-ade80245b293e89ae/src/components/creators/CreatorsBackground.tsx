...
/**
 * Premium background for the Creators page
 * Uses CSS animations instead of framer-motion to prevent constant React re-renders
 * Matches the Clips page premium purple aesthetic
 */
const CreatorsBackground = memo(forwardRef<HTMLDivElement, Record<string, never>>(function CreatorsBackground(_, ref) {
    ...
    <div ref={ref} className={`fixed inset-0 overflow-hidden pointer-events-none transition-opacity duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      ...
      >
        <defs>
          ...
          <linearGradient id="creatorsGlow1" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <linearGradient id="creatorsGlow2" x1="100%" y1="0%" x2="0%" y2="100%">
          ...
          <linearGradient id="creatorsGlow3" x1="50%" y1="0%" x2="50%" y2="100%">
            <stop offset="0%" stopColor="hsl(265 100% 72%)" stopOpacity="0.4" />
            <stop offset="100%" stopColor="hsl(275 100% 58%)" stopOpacity="0.1" />
          </linearGradient>
          
          <linearGradient id="creatorsVioletLine" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <linearGradient id="creatorsMagentaLine" x1="0%" y1="0%" x2="100%" y2="0%">
          ...
          <radialGradient id="creatorsCircleGlow1" cx="50%" cy="50%" r="50%">
          ...
          <radialGradient id="creatorsCircleGlow2" cx="50%" cy="50%" r="50%">
          ...
          <filter id="creatorsSoftGlow" x="-50%" y="-50%" width="200%" height="200%">
          ...
          <filter id="creatorsHeavyGlow" x="-100%" y="-100%" width="300%" height="300%">
        ...
        <circle
          ...
          cy="20%"
          r="250"
          fill="url(#creatorsCircleGlow1)"
          filter="url(#creatorsHeavyGlow)"
        ...
        <path
          ...
          stroke="url(#creatorsVioletLine)"
          strokeWidth="2"
          fill="none"
          filter="url(#creatorsSoftGlow)"
        />
        
        <path
          d="M-50,600 Q400,450 800,550 T1400,480 T2000,580"
          stroke="url(#creatorsMagentaLine)"
          strokeWidth="1.5"
          fill="none"
          filter="url(#creatorsSoftGlow)"
          style={{ opacity: 0.8 }}
...
export default CreatorsBackground;