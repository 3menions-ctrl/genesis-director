...
// Environment presets with unique epic ideas
const ENVIRONMENT_PRESETS = [
  ...
  },
  {
    id: 'ocean_breeze',
    name: 'Ocean Breeze',
    description: 'Crystal blue waters, soft beach light, vacation paradise',
    category: 'exterior',
    image: coastalSerenityImg,
    lighting: { type: 'natural', direction: 'overhead', intensity: 'bright', temperature: 'neutral', timeOfDay: 'midday' },
    colorPalette: { primary: '#00CED1', secondary: '#40E0D0', accent: '#F5DEB3', shadows: '#1E90FF' },
    mood: 'refreshing',
    icon: Waves,
    is_trending: true,
  },
  {
    ...
    description: 'Mystical woodland with dappled light filtering through ancient trees',
    category: 'exterior',
  ...
  },
  {
    id: 'alpine_summit',
    name: 'Alpine Summit',
    description: 'Epic mountain peaks, crisp air, adventure and freedom',
    category: 'exterior',
    image: alpineDawnImg,
    lighting: { type: 'natural', direction: 'low_angle', intensity: 'bright', temperature: 'cool', timeOfDay: 'dawn' },
    colorPalette: { primary: '#87CEEB', secondary: '#F0F8FF', accent: '#FF6347', shadows: '#4682B4' },
    mood: 'epic',
    icon: Mountain,
    is_trending: true,
  },
  {
    id: 'clean_studio',
    name: 'Clean Studio',
    description: 'Professional white backdrop, perfect for products and talking heads',
    category: 'interior',
  ...
  },
  {
    id: 'moody_overcast',
    name: 'Moody Overcast',
    description: 'Dramatic grey skies, soft shadows, cinematic tension',
    category: 'exterior',
    image: overcastDramaImg,
    lighting: { type: 'natural', direction: 'diffused', intensity: 'soft', temperature: 'cool', timeOfDay: 'overcast' },
    colorPalette: { primary: '#708090', secondary: '#778899', accent: '#2F4F4F', shadows: '#36454F' },
    mood: 'dramatic',
    icon: CloudSun,
    is_trending: true,
  },
  // MORE EPIC ENVIRONMENTS
  {
    id: 'desert_dunes',
    name: 'Desert Dunes',
    description: 'Endless golden sand waves under blazing sun, Lawrence of Arabia vibes',
    category: 'exterior',
    image: goldenHourStudioImg,
    lighting: { type: 'natural', direction: 'overhead', intensity: 'harsh', temperature: 'warm', timeOfDay: 'midday' },
  ...
  },
  {
    id: 'noir_detective',
    name: 'Noir Detective',
    description: 'Hard shadows, venetian blinds, 1940s mystery atmosphere',
    category: 'interior',
    image: neonNoirCityImg,
    lighting: { type: 'artificial', direction: 'harsh', intensity: 'high_contrast', temperature: 'neutral', timeOfDay: 'night' },
    colorPalette: { primary: '#1C1C1C', secondary: '#2D2D2D', accent: '#C0C0C0', shadows: '#0A0A0A' },
    mood: 'mysterious',
    icon: Moon,
    is_popular: true,
  },
  {
    ...
    description: 'Lush palm trees, turquoise lagoon, island escape dreams',
    category: 'exterior',
    image: coastalSerenityImg,
    lighting: { type: 'natural', direction: 'filtered', intensity: 'bright', temperature: 'warm', timeOfDay: 'afternoon' },
    colorPalette: { primary: '#00FA9A', secondary: '#00CED1', accent: '#FF6B6B', shadows: '#2E8B57' },
    mood: 'paradise',
    icon: Waves,
  },
  {
    id: 'autumn_woods',
    name: 'Autumn Woods',
    description: 'Fiery fall colors, crisp air, crunchy leaves underfoot',
    category: 'exterior',
    image: forestMystiqueImg,
    lighting: { type: 'natural', direction: 'side', intensity: 'soft', temperature: 'warm', timeOfDay: 'afternoon' },
    colorPalette: { primary: '#D2691E', secondary: '#FF8C00', accent: '#8B0000', shadows: '#654321' },
    mood: 'nostalgic',
    icon: TreePine,
  },
  {
    id: 'arctic_tundra',
    name: 'Arctic Tundra',
    description: 'Pristine white snow, ice blue shadows, polar expedition',
    category: 'exterior',
    image: alpineDawnImg,
    lighting: { type: 'natural', direction: 'reflected', intensity: 'bright', temperature: 'very_cool', timeOfDay: 'midday' },
    colorPalette: { primary: '#E8F4F8', secondary: '#B0E0E6', accent: '#4169E1', shadows: '#5F9EA0' },
    mood: 'serene',
    icon: Snowflake,
  },
  {
    ...
    description: 'Floor-to-ceiling windows, city skyline, sophistication',
    category: 'interior',
    image: modernMinimalistImg,
    lighting: { type: 'mixed', direction: 'ambient', intensity: 'soft', temperature: 'warm', timeOfDay: 'blue_hour' },
    colorPalette: { primary: '#1A1A1A', secondary: '#333333', accent: '#FFD700', shadows: '#0D0D0D' },
    mood: 'luxurious',
    icon: Building2,
    is_popular: true,
  },
  {
    id: 'misty_morning',
    name: 'Misty Morning',
    description: 'Ethereal fog, soft light, mysterious and peaceful',
    category: 'exterior',
    image: overcastDramaImg,
    lighting: { type: 'natural', direction: 'diffused', intensity: 'low', temperature: 'cool', timeOfDay: 'dawn' },
    colorPalette: { primary: '#D3D3D3', secondary: '#A9A9A9', accent: '#696969', shadows: '#808080' },
    mood: 'ethereal',
    icon: CloudSun,
  },
  {
    ...
    description: 'Warm wood, morning light through windows, homey comfort',
    category: 'interior',
    image: cozyFirelightImg,
    lighting: { type: 'natural', direction: 'window', intensity: 'soft', temperature: 'warm', timeOfDay: 'morning' },
    colorPalette: { primary: '#DEB887', secondary: '#D2B48C', accent: '#556B2F', shadows: '#8B7355' },
    mood: 'cozy',
    icon: Home,
  },
  {
    id: 'volcanic_drama',
    name: 'Volcanic Drama',
    description: 'Molten lava glow, ash-filled skies, raw earth power',
    category: 'exterior',
    image: overcastDramaImg,
  ...
  },
  {
    ...
    description: 'Deep blue light filtering down, coral colors, aquatic mystery',
    category: 'exterior',
    image: coastalSerenityImg,
    lighting: { type: 'filtered', direction: 'overhead', intensity: 'dappled', temperature: 'cool', timeOfDay: 'midday' },
    colorPalette: { primary: '#006994', secondary: '#00CED1', accent: '#FF7F50', shadows: '#00008B' },
    mood: 'mysterious',
    icon: Waves,
  },
  {
    id: 'cherry_blossom',
    name: 'Cherry Blossom',
    description: 'Soft pink petals, spring in Japan, romantic and delicate',
    category: 'exterior',
    image: goldenHourStudioImg,
